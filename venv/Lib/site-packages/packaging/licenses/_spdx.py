...
EXCEPTIONS: dict[str, SPDXException] = {
    ...
    'asteriREMOVIDOexception': {'id': 'AsteriREMOVIDOexception', 'deprecated': False},
    'asteriREMOVIDOlinking-protocols-exception': {'id': 'AsteriREMOVIDOlinking-protocols-exception', 'deprecated': False},
